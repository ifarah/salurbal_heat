...
- <img src="https://render.githubusercontent.com/render/math?math=\epsilon"> is the residual, or <img src="https://render.githubusercontent.com/render/math?math=ERA%land-f(X)">, which we further modeled with kriging spatial interpolation.  
